/* Garlicjs dist/garlic.min.js build version 1.1.2 http://garlicjs.org */
...
onRetrieve:function(){}};b(window).on("load",function(){b('[data-persist="garlic"]').each(function(){b(this).garlic()})})}(window.jQuery||window.Zepto);